...
console.log("Original dnaTwo\n",dnaTwo);
//1) Replace the gene "GCT" with "AGG", and then print the altered strand.
dnaTwo = dnaTwo.replace("GCT","AGG");
console.log("Revised dnaTwo\n",dnaTwo);
...
let cat = dna.slice(dna.indexOf("CAT"),dna.indexOf("CAT") + 3);
console.log(`${dna.slice(4,7).toLowerCase()}o ${cat.toLowerCase()}`);
