...
let arrLength = practiceFile.push(false,-4.6,"87"); // The push method also returns the lenght of the array which is assigned to variable arrLenght
console.log(practiceFile);

console.log(`The length of this array is now has ${arrLength} elements`);
